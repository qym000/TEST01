...
function getTemplate() {
  ...
  // 请求数据
    $.ajax({
      url : "demo_coding-procedure!getTemplate.action",
      type : "post",
      dataType : "json",
...
function openDetailWin() {
    $("#inputWin").window({
        open : true,
        headline:'高级设置',
        content:'<iframe id="myframe" src=demo_coding-procedure!toProcedureDetailInput.action scrolling="no" frameborder="0" style="width:100%;height:100%;overflow:hidden;" />',
        panelWidth:600,
        panelHeight:250
      });
      ...
      <div class="myui-form">
        ...
        <div class="form" style="width:800px;height:110px;margin:0;padding-left:150px;padding-top:20px">
          <div style="margin-top:30px">
            <h3>无需参数设置，请直接“生成模板”或进行“高级设置”。</h3>
          </div>
        </div>
