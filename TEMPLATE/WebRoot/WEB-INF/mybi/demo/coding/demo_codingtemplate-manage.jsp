...
<script type="text/javascript">
	var setting = {
		...
		async: {
			...
			url:"demo_coding-template!getDemoTree.action" // 异步请求url
		},
		callback : {
	...
	function zTreeOnClick(event, treeId, treeNode) {
		add_onload();
		$("#api").attr("src","demo_coding-template!toContent.action?id=" + treeNode.id);
	}
	...
	function ztreeOnAsyncSuccess(event,treeId,treeNode,msg) {
		...
		if (nodes != null && nodes.length > 0) {
			add_onload();
			$("#api").attr("src", "demo_coding-template!toContent.action?id=" + nodes[0].id)
		}
	}
...
<div class="myui-layout">
	<div class="rowgroup">
		<div class="content" style="width:250px;height:672px;" title="代码助手">
