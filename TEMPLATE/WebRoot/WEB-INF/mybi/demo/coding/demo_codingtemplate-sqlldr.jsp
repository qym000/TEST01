...
function getTemplate() {
  ...
  // 请求数据
    $.ajax({
      url : "demo_coding-sqlldr!getTemplate.action",
      type : "post",
      data : {
        connectId : connectId,
        tableName : tableName
...
function openDetailWin() {
    $("#inputWin").window({
        open : true,
        headline:'高级设置',
        content:'<iframe id="myframe" src=demo_coding-sqlldr!toSqlldrDetailInput.action scrolling="no" frameborder="0" style="width:100%;height:100%;overflow:hidden;" />',
        panelWidth:600,
        panelHeight:520
      });
