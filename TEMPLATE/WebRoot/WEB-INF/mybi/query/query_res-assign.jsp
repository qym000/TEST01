...
<script type="text/javascript">
	...
	function loadZTree(){
		add_onload();//开启蒙板层
		$.getJSON("${ctx}/query_security!findResList.action",{"ids_role": ids_role, "restyp" : gv_restyp},function(data){
    ...
    function sbt(){
		...
		add_onload();//开启蒙板层
		$.post("query_security!assignResList.action",{ids_role : ids_role, obj_ids : obj_ids, restyp : gv_restyp},function(data){ 
			if(data.result=="succ"){
				//添加成功
