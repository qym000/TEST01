	...
	$(function(){
		...
		$.formValidator.initConfig({formID:"form_input",
			...
			onSuccess:function(){
				...
				$.post("pim_host!saveHostObj.action", param, function(data){ 
					if(data.result=="succ"){
		...
		.ajaxValidator({
			dataType : "text",
			url : "pim_host!checkHostNameUnique.action",
			type : "POST",
			data: {},
		...
		<form id="form_input" method="post">
			 <div class="item">
				<ul>
					...
					<li><input id="hostName" name="pim_host.hostName" maxlength="30" class="myui-text"/></li>
			 ...
			 <div class="item">
				<ul>
					...
					<li><input id="username" name="username" maxlength="20" class="myui-text"/></li>
			 ...
			 <div class="item">
				<ul>
					...
					<li><input id="password" type="password" name="password" maxlength="20" class="myui-text"/></li>
