	...
	$(function(){
		$.formValidator.initConfig({formID:"form_input",
			...
			onSuccess:function(){
				...
				$.post("pim_ftp!saveFtpObj.action", param, function(data){ 
					if(data.result=="succ"){
		...
		.ajaxValidator({
			dataType : "text",
			url : "pim_ftp!checkFtpUnique.action",
			type : "POST",
			data: {},
		...
		<form id="form_input" method="post">
			 <div class="item">
				<ul>
					...
					<li><input id="ftpDesc" name="pim_ftp.ftpDesc" maxlength="30" class="myui-text"/></li>
			 ...
			 <div class="item">
				<ul>
					...
					<li><input id="serverIp" name="serverIp" maxlength="20" class="myui-text"/></li>
			 ...
			 <div class="item">
				<ul>
					...
					<li><input id="serverPort" name="serverPort" maxlength="10" class="myui-text" value="21"/></li>
			 ...
			 <div class="item">
				<ul>
					...
					<li><input id="password"  type="password" name="password" maxlength="30" class="myui-text"/></li>
			 ...
			 <div class="item">
				<ul>
					...
					<li><input id="url" name="url" maxlength="100"  class="myui-text"/></li>
