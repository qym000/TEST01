	...
	$(function(){
		$.formValidator.initConfig({formID:"form_input",
			...
			onSuccess:function(){
				add_onload();//开启蒙板层
				var param = {
					"pim_jdbc.connectId":$.trim($("#connectId").val()),
				...
				$.post("pim_jdbc!updateJdbcObj.action", param, function(data){ 
					if(data.result=="succ"){
...
<div class="myui-form">
	<div class="form">
		<form id="form_input" method="post">
			<input type="hidden" id="connectId" name="connectId" value="${obj.connectId}"/>
			 <div class="item">
				<ul>
					<li class="desc" style="width:120px;"><b>*</b><s:text name="pim_jdbc_serverip"/>：</li>
					<li><input id="ip" name="ip" maxlength="15" class="myui-text" value="${obj.ip}"/></li>
			 ...
			 <div class="item">
				<ul>
					...
					<li><input id="port" name="port" maxlength="15" class="myui-text" value="${obj.port}"/></li>
			 ...
			 <div class="item">
				<ul>
					...
					<li><input id="sid" name="sid" maxlength="50" class="myui-text" value="${obj.sid}"/></li>
			 ...
			 <div class="item">
				<ul>
					...
					<li><input id="password"  type="password" name="password" maxlength="10" class="myui-text" value="${obj.password}"/></li>
			 ...
			 <div class="item">
				<ul>
					...
					<li><textarea id="remark" name="remark" class="myui-textarea" style="width:200px;">${obj.remark}</textarea></li>
