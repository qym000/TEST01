	...
	function initPage() {
		...
		$.formValidator.initConfig({formID:"form_input",
			...
			onSuccess:function(){
				// 参数对象
				var paramObj = {
					"planObj.planId" : "${planObj.planId}",
					"planObj.planName" : $.trim($("#planName").val()),
					"planObj.planDesc" : $.trim($("#planDesc").val())
				}
				//开启蒙板层
				add_onload();
				$.post("${ctx}/gdp_plan!updatePlanObj.action",paramObj,function(data){ 
					if(data.result=="succ"){
						//回显刚才操作的记录
		...
		<form id="form_input" method="post">
			 <div class="item">
				<ul>
					...
					<li><input id="planName" name="planName" value="${planObj.planName}" maxlength="25" class="myui-text" style="width:160px;"/></li>
			 ...
			 <div class="item">
				<ul>
					...
					<li><textarea id="planDesc" name="planDesc" class="myui-textarea" style="width:160px;height:90px;">${planObj.planDesc}</textarea></li>
