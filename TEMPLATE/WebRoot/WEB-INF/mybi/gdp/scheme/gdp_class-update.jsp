	...
	function initPage() {
		...
		$.formValidator.initConfig({formID:"form_input",
			...
			onSuccess:function(){
				// 参数对象
				var paramObj = {
					"classObj.classId" : "${classObj.classId}",
					"classObj.className" : $.trim($("#className").val()),
					"classObj.classDesc" : $.trim($("#classDesc").val())
				}
				// 开启蒙板层
				add_onload();
				$.post("${ctx}/gdp_scheme-class!updateSchemeClassObj.action",paramObj,function(data){ 
					if(data.result=="succ"){
						//回显刚才操作的记录
		...
		<form id="form_input" method="post">
			 <div class="item">
				<ul>
					...
					<li><input id="className" name="className" value="${classObj.className}" maxlength="25" class="myui-text" style="width:160px;"/></li>
			 ...
			 <div class="item">
				<ul>
					...
					<li><textarea id="classDesc" name="classDesc" class="myui-textarea" style="width:160px;">${classObj.classDesc}</textarea></li>
