	...
	function initPage() {
		...
		$.formValidator.initConfig({formID:"form_input",
			...
			onSuccess:function(){
				...
				//开启蒙板层
				add_onload();
				$.post("${ctx}/rdd_resdown!updateResInfoObj.action",paramObj,function(data){ 
					if(data.result=="succ"){
						//回显刚才操作的记录
		...
		<form id="form_input" method="post">
			 <div class="item">
				<ul>
					...
					<li><input id="resName" name="resName" value="${resObj.resName}" maxlength="50" class="myui-text" style="width:160px;"/></li>
			 ...
			 <div class="item">
				<ul>
					...
					<li><textarea id="resServer" name="resServer" class="myui-textarea" style="width:160px;height:70px;">${resObj.resServer}</textarea></li>
