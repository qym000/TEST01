  ...
  function initPage() {
    ...
    $.formValidator.initConfig({formID:"form_input",
      ...
      onSuccess:function(){
        ...
        //开启蒙板层
        add_onload();
        $.post("${ctx}/gdp_fix-dim!updateDimObj.action",paramObj,function(data){ 
          if(data.result=="succ"){
            //回显刚才操作的记录
    ...
    <form id="form_input" method="post">
       ...
       <div class="item">
        <ul>
          ...
          <li><input id="dimCode" name="dimCode" value="${dimObj.dimCode }" maxlength="10" class="myui-text" style="width:160px;"/></li>
       ...
       <div class="item">
        <ul>
          ...
          <li><input id="dimInfo" name="dimInfo" value="${dimObj.dimInfo }" maxlength="30" class="myui-text" style="width:160px;"></textarea></li>
       ...
       <div class="item">
        <ul>
          ...
          <li><input id="dimKeyword" name="dimKeyword" value="${dimObj.dimKeyword }" class="myui-text" style="width:160px;"></textarea></li>
