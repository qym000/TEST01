  ...
  function initPage() {
    ...
    $.formValidator.initConfig({formID:"form_input",
      ...
      onSuccess:function(){
        ...
        //开启蒙板层
        add_onload();
        $.post("${ctx}/gdp_fix-itemtyp!saveItemtypObj.action",paramObj,function(data){ 
          if(data.result=="succ"){
            //回显刚才操作的记录
    ...
    <form id="form_input" method="post">
       <div class="item">
        <ul>
          ...
          <li><input id="itemtypCode" name="itemtypCode" maxlength="10" class="myui-text" style="width:160px;"/></li>
       ...
       <div class="item">
        <ul>
          ...
          <li><input id="itemtypName" name="itemtypName" maxlength="30" class="myui-text" style="width:160px;"></textarea></li>
