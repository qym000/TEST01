  ...
  function initPage() {
    ...
    $.formValidator.initConfig({formID:"form_input",
      ...
      onSuccess:function(){
        // 参数对象
        var paramObj = {
          "itemObj.itemCode" : $.trim($("#itemCode").val()),
          "itemObj.itemName" : $.trim($("#itemName").val()),
          "itemObj.itemAlias" : $.trim($("#itemAlias").val()),
        }
        //开启蒙板层
        add_onload();
        $.post("${ctx}/gdp_fix-item!saveItemObj.action",paramObj,function(data){ 
          if(data.result=="succ"){
            //回显刚才操作的记录
    ...
    $("#itemCode").formValidator().inputValidator({min:1,onError:"<s:text name='gdp_common_cannotBeEmpty'/>"});
    ...
    <form id="form_input" method="post">
       <div class="item">
        <ul>
          ...
          <li><input id="itemCode" name="itemCode" maxlength="6" value="${itemCode }" class="myui-text" style="width:160px;"/></li>
       ...
       <div class="item">
        <ul>
          ...
          <li><input id="itemName" name="itemName" maxlength="30" class="myui-text" style="width:160px;"/></li>
       ...
       <div class="item">
        <ul>
          ...
          <li><input id="itemAlias" name="itemAlias" maxlength="30" class="myui-text" style="width:160px;"/></li>
